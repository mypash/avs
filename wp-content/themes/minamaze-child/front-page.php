...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="activity-container">
		<dl class="inner-wrap">
			...
			<img src="/wp-content/uploads/evo-team_s.png" alt="エヴォリスタ サッカーチーム" width="600" height="300" class="aligncenter size-full wp-image-128" /></a>
			</dt>
			<dd>
				<div class="desc">
		...
		<dl class="inner-wrap">
			...
			<img src="/wp-content/uploads/ut15-class_s.jpg" alt="ut15-class_s" width="600" height="300" class="aligncenter size-full wp-image-220" />
			</dt>
			<dd>
				<div class="desc">
		...
		<dl class="inner-wrap">
			...
			<img src="/wp-content/uploads/club09_1.jpg" alt="club09_1" width="600" height="300" class="aligncenter size-full wp-image-210" />
			</dt>
			<dd>
				<div class="desc">
